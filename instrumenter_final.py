            ...
            if t["type"] == "RBRACE":
                ...
                if context == "function":
                    if not has_return:
                        ...
                        open_line = char_to_line(self.source, open_pos)
                ...
                if kw == "if":
                    ...
                    if context == "function":
                        ...
                        has_return = True
                        return_pos = t["start"]
                        # Block spans from the function's OPENING BRACE
                        # (not the return line) so every line in the body
                        # — before and after this return — is covered.
                        self.block_map.append({
                            "flag":       flag,
                            "start_line": char_to_line(self.source, open_pos),
