...
def generate_report(
    ...
    for src in source_files:
        ...
        file_results.append({
            "filename":  p.name,
            "source":    analyser.source,   # normalized source — matches block_map line numbers
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        output_in = input("Output HTML file [coverage_report.html]: ").strip()
        output = output_in if output_in else "coverage_report.html"
    ...
    generate_report(sources, log, output)
